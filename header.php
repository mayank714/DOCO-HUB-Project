    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:200px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:200px;overflow:hidden;">
            <div>
                <img data-u="image" src="banner.jpg" />
                <div u="thumb">May I Help You</div>
            </div>
            <div>
                <img data-u="image" src="banner2.jpg" />
                <div u="thumb">May I Help You</div>
            </div>
            <div>
                <img data-u="image" src="banner3.jpg" />
               <div u="thumb">May I Help You</div>
            </div>
            <div>
                <img data-u="image" src="banner4.jpg" />
                <div u="thumb">May I Help You</div>
            </div>
            <div>
                <img data-u="image" src="banner5.jpg" />
                <div u="thumb">May I Help You</div>
            </div>
    ...
    <div style="background-color:#FF1452;height:50px">
    <form method='post' action='index.php'>
    <table style="height:50px" cellspacing="0" cellpadding="0" align='center'>
    <tr><td>Search:<input type='text' name='t1'> <input type='radio' name='r1' value='city' checked>City <input type='radio' name='r1' value='specialization'>Specialization <input type=submit name='b1' value='Search'></td></tr></table></form><hr>
	</div>
